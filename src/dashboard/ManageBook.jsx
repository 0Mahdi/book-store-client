...
const ManageBook = () => {
    ...
    return (
        <div className="px-4 my-12">
            <h2 className="mb-8 text-3xl font-bold text-zinc-400">Manage Your Books</h2>
                    ...
                    allBooks.map((book, index) => <Table.Body key={book._id} className="divide-y">
                        <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                            ...
                            <Table.Cell>
                                ...
                                <button onClick={() => handleDelete(book._id)} className='bg-red-600 px-4 py-1 font-semibold text-white rounded-smm hover:bg-sky-600'>Delete</button>
                            </Table.Cell>
                        </Table.Row>
                    </Table.Body> )
                }
